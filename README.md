# Offline Server Configuration for Transport Layer Security 1.3 Zero-RTT

This is the working area for the Individual internet-draft, "Offline Server Configuration for Transport Layer Security 1.3 Zero-RTT".

* [Editor's copy](https://unicorn-wg.github.io/tls-offline-config/)
